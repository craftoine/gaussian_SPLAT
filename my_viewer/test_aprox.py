...
plt.legend()
plt.show()
plt.plot(x,[f_0(x_) for x_ in x],label='transmittance multiplied by red mixture', color = 'red')
plt.plot(x,[f_1(x_) for x_ in x],label='transmittance multiplied by green mixture', color = 'green')
plt.plot(x,[f_2(x_) for x_ in x],label='transmittance multiplied by blue mixture', color = 'blue')
plt.xlabel('x')
